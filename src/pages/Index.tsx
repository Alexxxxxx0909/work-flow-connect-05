      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="container-custom flex items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center space-x-4">
            <Link to="/login" className="text-gray-700 dark:text-gray-300 hover:text-wfc-purple">Iniciar Sesión</Link>
            <Link to="/register">
          ...
          <div className="md:hidden flex items-center">
            ...
            <Link to="/login" className="text-sm text-gray-700 dark:text-gray-300 hover:text-wfc-purple">
              Iniciar Sesión
            </Link>
          </div>
        </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-center">
              <div className="inline-flex items-center justify-center h-12 w-12 rounded-full bg-wfc-purple/10 dark:bg-wfc-purple/20 text-wfc-purple mb-4">
                <Briefcase className="h-6 w-6" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Propuestas de trabajo</h3>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Mensajería integrada</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Perfiles profesionales</h3>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-medium mb-1 text-gray-800 dark:text-white">Sin comisiones</h3>
            ...
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-wfc-purple mr-3 mt-1 flex-shrink-0" />
              <div>
                <h3 className="font-medium mb-1 text-gray-800 dark:text-white">Pagos seguros</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">
            ...
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-wfc-purple mr-3 mt-1 flex-shrink-0" />
              <div>
                <h3 className="font-medium mb-1 text-gray-800 dark:text-white">Soporte 24/7</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">
            ...
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-wfc-purple mr-3 mt-1 flex-shrink-0" />
              <div>
                <h3 className="font-medium mb-1 text-gray-800 dark:text-white">Comunidad global</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">
